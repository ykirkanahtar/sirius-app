...
namespace Sirius.Housings
{
    public interface IHousingManager : IDomainService
    {
        ...
        void BulkIncreaseBalance(IEnumerable<Housing> housings, decimal amount, ResidentOrOwner residentOrOwner);
        Task IncreaseBalance(Housing housing, decimal amount, ResidentOrOwner residentOrOwner);
        Task DecreaseBalance(Housing housing, decimal amount, ResidentOrOwner residentOrOwner);
