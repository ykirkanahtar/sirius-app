...
namespace Sirius.Migrations
{
    ...
    [Migration("20220819092943_AddPeriodIdToHousingPaymentPlan")]
    partial class AddPeriodIdToHousingPaymentPlan
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sirius.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sirius.HousingPaymentPlans.HousingPaymentPlan", b =>
                {
                    ...
                    b.Property<int?>("FirstHousingDueTransferIsResidentOrOwner")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sirius.HousingPaymentPlans.HousingPaymentPlanGroupHousing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppHousingPaymentPlanGroupHousings");
                });

            modelBuilder.Entity("Sirius.HousingPaymentPlans.HousingPaymentPlanGroupHousingCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppHousingPaymentPlanGroupHousingCategories");
                });
            ...
            modelBuilder.Entity("Sirius.Housings.Housing", b =>
                {
                    ...
                    b.Property<bool>("TenantIsResiding")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("AppHousings");
                });

            modelBuilder.Entity("Sirius.Housings.HousingCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppHousingCategories");
                });
            ...
            modelBuilder.Entity("Sirius.Housings.HousingPerson", b =>
                {
                    ...
                    b.ToTable("AppHousingPeople");
                });

            modelBuilder.Entity("Sirius.Inventories.Inventory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sirius.Inventories.InventoryType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sirius.PaymentAccounts.AccountBook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("HousingIdForNetting")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("NettingHousing")
                        .HasColumnType("bit");

                    b.Property<Guid?>("PaymentCategoryId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PaymentCategoryIdForNetting")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sirius.PaymentAccounts.AccountBookFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppAccountBookFiles");
                });

            modelBuilder.Entity("Sirius.PaymentAccounts.PaymentAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("TenantIsOwner")
                        .HasColumnType("bit");

                    b.HasKey("Id");

                    b.ToTable("AppPaymentAccounts");
                });

            modelBuilder.Entity("Sirius.PaymentCategories.PaymentCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("DefaultFromPaymentAccountId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultToPaymentAccountId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppPaymentCategories");
                });

            modelBuilder.Entity("Sirius.People.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sirius.Periods.Period", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Sirius.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Sirius.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Sirius.HousingPaymentPlans.HousingPaymentPlanGroupHousing", b =>
                {
                    b.HasOne("Sirius.HousingPaymentPlans.HousingPaymentPlanGroup", null)
                        .WithMany("HousingPaymentPlanGroupHousings")
                        .HasForeignKey("HousingPaymentPlanGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Sirius.HousingPaymentPlans.HousingPaymentPlanGroupHousingCategory", b =>
                {
                    b.HasOne("Sirius.HousingPaymentPlans.HousingPaymentPlanGroup", null)
                        .WithMany("HousingPaymentPlanGroupHousingCategories")
                        .HasForeignKey("HousingPaymentPlanGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Sirius.Housings.Housing", b =>
                {
                    b.HasOne("Sirius.Housings.Block", "Block")
                        .WithMany()
                        .HasForeignKey("BlockId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sirius.Housings.HousingCategory", "HousingCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Sirius.Housings.HousingPerson", b =>
                {
                    b.HasOne("Sirius.Housings.Housing", "Housing")
                        .WithMany("HousingPeople")
                        .HasForeignKey("HousingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sirius.People.Person", "Person")
                        .WithMany()
            ...
            modelBuilder.Entity("Sirius.Inventories.Inventory", b =>
                {
                    b.HasOne("Sirius.PaymentAccounts.AccountBook", null)
                        .WithMany("Inventories")
                        .HasForeignKey("AccountBookId");

                    b.HasOne("Sirius.Inventories.InventoryType", "InventoryType")
                        .WithMany()
            ...
            modelBuilder.Entity("Sirius.PaymentAccounts.AccountBook", b =>
                {
                    b.HasOne("Sirius.PaymentAccounts.PaymentAccount", "FromPaymentAccount")
                        .WithMany()
                        .HasForeignKey("FromPaymentAccountId");

                    b.HasOne("Sirius.PaymentAccounts.PaymentAccount", "ToPaymentAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("Sirius.HousingPaymentPlans.HousingPaymentPlanGroup", b =>
                {
                    b.Navigation("HousingPaymentPlanGroupHousingCategories");

                    b.Navigation("HousingPaymentPlanGroupHousings");

                    b.Navigation("HousingPaymentPlans");
                });

            modelBuilder.Entity("Sirius.Housings.Housing", b =>
                {
                    b.Navigation("HousingPeople");
                });

            modelBuilder.Entity("Sirius.PaymentAccounts.AccountBook", b =>
                {
                    b.Navigation("AccountBookFiles");
