...
{
    public abstract class SiriusWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SiriusWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SiriusWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SiriusDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SiriusDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SiriusDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SiriusDbContext, Task<T>> func)
        {
            T result;
